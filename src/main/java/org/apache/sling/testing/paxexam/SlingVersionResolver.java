...
public class SlingVersionResolver implements VersionResolver {
    ...
    public SlingVersionResolver() {
        ...
        versions.put("org.apache.felix:org.apache.felix.eventadmin", "1.4.10");
        versions.put("org.apache.felix:org.apache.felix.http.jetty", "3.4.8");
        ...
        versions.put("org.apache.felix:org.apache.felix.webconsole.plugins.ds", "2.0.8");
        ...
        versions.put("org.apache.felix:org.apache.felix.metatype", "1.1.6");
        versions.put("org.apache.felix:org.apache.felix.scr", "2.0.14");
        ...
        versions.put("org.apache.jackrabbit:oak-commons", "1.8.1");
        versions.put("org.apache.jackrabbit:oak-core", "1.8.1");
        versions.put("org.apache.jackrabbit:oak-core-spi", "1.8.1");
        versions.put("org.apache.jackrabbit:oak-jcr", "1.8.1");
        versions.put("org.apache.jackrabbit:oak-lucene", "1.8.1");
        versions.put("org.apache.jackrabbit:oak-query-spi", "1.8.1");
        versions.put("org.apache.jackrabbit:oak-security-spi", "1.8.1");
        versions.put("org.apache.jackrabbit:oak-segment-tar", "1.8.1");
        versions.put("org.apache.jackrabbit:oak-store-composite", "1.8.1");
        versions.put("org.apache.jackrabbit:oak-store-document", "1.8.1");
