...
public class SlingVersionResolver implements VersionResolver {
    ...
    public SlingVersionResolver() {
        ...
        versions.put("ch.qos.logback:logback-classic", "1.5.32");
        versions.put("ch.qos.logback:logback-core", "1.5.32");
        versions.put("commons-fileupload:commons-fileupload", "1.6.0");
        versions.put("commons-io:commons-io", "2.21.0");
        versions.put("com.fasterxml.jackson.core:jackson-annotations", "2.21");
        versions.put("com.fasterxml.jackson.core:jackson-core", "2.21.2");
        versions.put("com.fasterxml.jackson.core:jackson-databind", "2.21.2");
        versions.put("com.icegreen:greenmail", "2.1.8");
        versions.put("io.dropwizard.metrics:metrics-core", "3.2.6");
        versions.put("io.rest-assured:json-path", "6.0.0");
        versions.put("io.rest-assured:rest-assured", "6.0.0");
        versions.put("io.rest-assured:rest-assured-common", "6.0.0");
        versions.put("io.rest-assured:xml-path", "6.0.0");
        versions.put("jakarta.activation:jakarta.activation-api", "2.2.0-M1");
        versions.put("jakarta.mail:jakarta.mail-api", "2.2.0-M1");
        ...
        versions.put("org.apache.commons:commons-lang3", "3.20.0");
        ...
        versions.put("org.apache.felix:org.apache.felix.healthcheck.core", "2.3.0");
        versions.put("org.apache.felix:org.apache.felix.healthcheck.generalchecks", "3.0.8");
        versions.put("org.apache.felix:org.apache.felix.healthcheck.webconsoleplugin", "2.2.0");
        versions.put("org.apache.felix:org.apache.felix.http.jetty12", "1.1.8");
        versions.put("org.apache.felix:org.apache.felix.http.servlet-api", "6.1.0");
        ...
        versions.put("org.apache.felix:org.apache.felix.scr", "2.2.14");
        versions.put("org.apache.felix:org.apache.felix.webconsole", "5.0.18");
        ...
        versions.put("org.apache.groovy:groovy", "5.0.5");
        versions.put("org.apache.groovy:groovy-json", "5.0.5");
        versions.put("org.apache.groovy:groovy-xml", "5.0.5");
        ...
        versions.put("org.apache.sling:org.apache.sling.commons.crypto", "1.2.0");
        versions.put("org.apache.sling:org.apache.sling.commons.metrics", "1.2.14");
        versions.put("org.apache.sling:org.apache.sling.commons.scheduler", "2.7.14");
        ...
        versions.put("org.ops4j.pax.logging:pax-logging-api", "2.3.2");
        versions.put("org.ops4j.pax.logging:pax-logging-log4j2", "2.3.2");
        versions.put("org.ops4j.pax.logging:pax-logging-logback", "2.3.2");
        ...
        versions.put("org.ops4j.pax.url:pax-url-classpath", "3.0.2");
        versions.put("org.ops4j.pax.url:pax-url-commons", "3.0.2");
        versions.put("org.ops4j.pax.url:pax-url-wrap", "3.0.2");
        versions.put("org.ops4j.pax.tinybundles:tinybundles", "4.0.1");
        ...
        versions.put("org.owasp.encoder:encoder", "1.4.0");
        versions.put("org.rnorth.duct-tape:duct-tape", "1.0.8");
        versions.put("org.slf4j:slf4j-api", "2.0.17");
        versions.put("org.slf4j:slf4j-simple", "2.0.17");
        versions.put("org.slf4j:jcl-over-slf4j", "2.0.17");
        versions.put("org.testcontainers:testcontainers", "2.0.4");
