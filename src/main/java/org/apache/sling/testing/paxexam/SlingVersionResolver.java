...
public class SlingVersionResolver implements VersionResolver {
    ...
    public SlingVersionResolver() {
        ...
        versions.put("org.apache.aries.spifly:org.apache.aries.spifly.dynamic.bundle", "1.3.5");
        ...
        versions.put("org.apache.felix:org.apache.felix.configadmin", "1.9.24");
        versions.put("org.apache.felix:org.apache.felix.eventadmin", "1.6.2");
        versions.put("org.apache.felix:org.apache.felix.http.jetty", "4.2.0");
        versions.put("org.apache.felix:org.apache.felix.http.servlet-api", "2.0.0");
        ...
        versions.put("org.apache.felix:org.apache.felix.scr", "2.2.2");
        versions.put("org.apache.felix:org.apache.felix.webconsole", "4.8.2");
        ...
        versions.put("org.ops4j.pax.logging:pax-logging-api", "2.1.3");
        versions.put("org.ops4j.pax.logging:pax-logging-log4j2", "2.1.3");
        versions.put("org.ops4j.pax.logging:pax-logging-logback", "2.1.3");
        ...
        versions.put("org.ops4j.pax.url:pax-url-classpath", "2.6.11");
        versions.put("org.ops4j.pax.url:pax-url-commons", "2.6.11");
        versions.put("org.ops4j.pax.url:pax-url-wrap", "2.6.11");
        versions.put("org.ops4j.pax.tinybundles:tinybundles", "3.0.0");
        versions.put("org.osgi:org.osgi.service.component", "1.5.0");
        versions.put("org.osgi:org.osgi.util.function", "1.2.0");
        versions.put("org.osgi:org.osgi.util.promise", "1.2.0");
        versions.put("org.ow2.asm:asm", "9.3");
        versions.put("org.ow2.asm:asm-analysis", "9.3");
        versions.put("org.ow2.asm:asm-commons", "9.3");
        versions.put("org.ow2.asm:asm-util", "9.3");
        versions.put("org.ow2.asm:asm-tree", "9.3");
        ...
        versions.put("org.testcontainers:testcontainers", "1.17.3");
        versions.put("io.rest-assured:json-path", "5.1.1");
        versions.put("io.rest-assured:rest-assured", "5.1.1");
        versions.put("io.rest-assured:rest-assured-common", "5.1.1");
        versions.put("io.rest-assured:xml-path", "5.1.1");
        versions.put("jakarta.mail:jakarta.mail-api", "2.0.1");
        versions.put("com.composum.nodes:composum-nodes-commons", "4.1.2");
        versions.put("com.composum.nodes:composum-nodes-console", "4.1.2");
        versions.put("com.composum.nodes:composum-nodes-jslibs", "4.1.2");
        ...
        versions.put("org.apache.pdfbox:pdfbox", "2.0.26");
        ...
        versions.put("org.apache.sling:org.apache.sling.jcr.base", "3.1.10");
        ...
        versions.put("org.apache.sling:org.apache.sling.models.impl", "1.5.2");
        ...
        versions.put("org.apache.sling:org.apache.sling.scripting.groovy", "1.2.1-SNAPSHOT");
        ...
        versions.put("org.apache.sling:org.apache.sling.scripting.jsp", "2.6.0");
        ...
        versions.put("org.apache.sling:org.apache.sling.scripting.sightly", "1.4.18-1.4.0");
        ...
        versions.put("org.apache.sling:org.apache.sling.scripting.sightly.js.provider", "1.2.6");
        ...
        versions.put("org.apache.sling:org.apache.sling.serviceusermapper", "1.5.4");
