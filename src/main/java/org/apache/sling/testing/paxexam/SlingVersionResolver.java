...
public class SlingVersionResolver implements VersionResolver {
    ...
    public SlingVersionResolver() {
        ...
        versions.put("org.apache.jackrabbit:oak-blob", "1.6.7");
        versions.put("org.apache.jackrabbit:oak-commons", "1.6.7");
        versions.put("org.apache.jackrabbit:oak-core", "1.6.7");
        versions.put("org.apache.jackrabbit:oak-jcr", "1.6.7");
